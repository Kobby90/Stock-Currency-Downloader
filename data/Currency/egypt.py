...
def fetch_exchange_rates():
    ...
    if table:
        ...
        pdf_path = f"{output_folder}/Currency_egypt_{date.today()}.pdf"
        ...
        for filename in os.listdir(output_folder):
            if filename.startswith("Currency_egypt_"):
        ...
        with PdfPages(pdf_path) as pdf:
            ...
            ax.axis('tight')
            ax.axis('off')
            ax.set_title('Average Market Rate in EGP', fontweight="bold") # Adjust title padding
